...
- (void)viewDidLoadForImageMode {
    ...
    UIImageView *closeImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"IMG_close_white"]];
    closeImageView.frame = CGRectMake(8, 20, 33*mainRatio, 33*mainRatio);
